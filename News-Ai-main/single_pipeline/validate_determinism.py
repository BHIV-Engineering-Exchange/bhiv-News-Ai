...
import json
import hashlib
from truth_classifier import classify_truth
...
def run_validation():
    ...
    event_1 = {
        ...
        "truth_level": classify_truth([source_data]),
        "conflict_flag": detect_conflict(source_data["registry_reference_id"], [source_data]),
